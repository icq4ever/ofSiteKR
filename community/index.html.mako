...
<p>오픈프레임웍스 관련에 정보를 더 얻고 싶다면, <a href="http://www.openframeworks.cc/list-info/">커뮤니티 메일링 리스트</a>에 등록해주시기 바랍니다.</p>
...
<p>지금 당장 관여하고 싶으신가요? 오픈프레임웍스 커뮤니티는 항상 개발자, 디자이너, 작가, 이벤트 관리자, 또는 보다 나은 경험을 할 수 있도록 돕는 일반적인 열정을 가진 분들을 찾고 있습니다. 만약 이런 분들을 살펴보고 싶다면, 포럼의 <a href="http://forum.openframeworks.cc/index.php?board=31.0">collaborations</a>섹션을 살펴보시거나, 제공되고 있는 <a href="http://www.openframeworks.cc/tutorials/">튜토리얼</a>을 살펴보시기 바랍니다.</p>
...
<ul class="external_links" >
    ...
    <li><a href="https://forum.openframeworks.kr/"> 오픈프레임웍스 대한민국 포럼</a></li>
</ul>
...
<p><b>오픈프레임웍스 교육</b> - 혹시 워크샵, 수업 또는 어떤 이벤트에서 가르치시나요? <a href="http://www.openframeworks.cc/list-info/">오픈프레임웍스 메일링 리스트</a>에 올려주시면 이 페이지에 추가됩니다. 이미 진행된 워크샵, 수업이 있다면 <a href="http://wiki.openframeworks.cc/index.php?title=Education">교육 위키</a>페이지에 공유해주세요. <a href="http://forum.openframeworks.cc/">포럼</a>에서 다른 교육기회가 있는지도 확인해주세요.</p>
...
<p><b>다른 공헌들</b> - 오픈프레임웍스 커뮤니티는 항상 개발자, 디자이너, 작가, 이벤트 관리자, 또는 보다 나은 경험을 할 수 있도록 돕는 일반적인 열정을 가진 분들을 찾고 있습니다. <a href="http://www.openframeworks.cc/list-info/">메일링 리스트</a>와 <a href="http://twitter.com/openFrameworks"> 트위터</a>에서 기회가 있는지 알아보세요</p>
