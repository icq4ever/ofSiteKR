...
몇 하드코어 너드와 해커들은 텍스트 편집기를 [뭘 쓸것인지를 가지고 싸후지만](http://en.wikipedia.org/wiki/Editor_war), 사실 어떤 편집기가 최고인지 올바른 정답은 없습니다. 여러분이 선택할 수 있는 편집기는 다양하지만, 잘 동작하는 세가지를 추천해드릴 수 있습니다. 
