...
오픈프레임은 개발자들이 새로운 플랫폼으로 쉽게 포팅할 수 있도록 변종시스템을 사용합니다. 라즈베리파이1은 armv61 아키텍쳐를, 라즈베리파이2는 armv7 아키텍쳐를 사용합니다. 라즈베리파이2가 아주 유명해진 이후, 오픈프레임웍스는 여러분이 arm7 아키텍쳐를 사용할 때, 라즈베리파이2를 사용하는 것으로 간주합니다.
