...
:translator: Yi donghoon <icq4ever@gmail.com>
...
-   이미지 불러오기와 저장 :http://freeimage.sourceforge.net/[FreeImage]
...
We learned in the last section that openFrameworks is *not* a programming language, but rather a software framework for creating http://en.wikipedia.org/wiki/C%2B%2B[`C++`] programs. But what is C++?
