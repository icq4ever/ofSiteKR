...
<p>저희는 누구나 브랜치, 실험, 제안을 할수 있도록 분산버전관리시스템인 깃을 사용하고 있습니다. <a href="http://github.com/openframeworks/openFrameworks">GitHub</a>의 네트워크 다이어그램을 살펴보시면 아시겠지만, 그것은 마치 외계인의 다이어그램처럼보일것입니다. 브랜치들이 얽혀있고, 코드 pulling이 서로 오고가고 있습니다. 이는 정말이지 전세계를 아우르는 핵심코드로 작업하는 거대한 커뮤니티입니다: 버그를 수정하고, pull request를 제출하고, 원하는 방향으로 도구를 다듬고 있습니다.</p>
